...
See [docs/PARALLEL_ORCHESTRATION.md](docs/PARALLEL_ORCHESTRATION.md) for details.
...
- Review [CLI_SPEC.md](docs/CLI_SPEC.md) for complete command reference
- Check [PARALLEL_ORCHESTRATION.md](docs/PARALLEL_ORCHESTRATION.md) for concurrency details
