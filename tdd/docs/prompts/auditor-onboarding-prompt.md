# Auditor Agent Onboarding Prompt

**Copy this entire prompt into a FRESH agent session to audit completed work.**

**IMPORTANT**: You should be in a NEW session (not the one that implemented the code) to avoid shared hallucinations and ensure objective verification.
